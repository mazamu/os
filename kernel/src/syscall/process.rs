...
// trace!("{}{}", module_path!(), "::sys_yield");
    suspend_current_and_run_next();
    0
}

pub fn sys_getpid() -> isize {
trace!("{}{}", module_path!(), "::sys_getpid");
    current_task().unwrap().pid.0 as isize
}

/// Syscall Fork which returns 0 for child process and child_pid for parent process
pub fn sys_fork() -> isize {
trace!("{}{}", module_path!(), "::sys_fork");
...
//引入虚地址后重写 sys_get_time
pub fn sys_get_time(_ts: *mut TimeVal, _tz: usize) -> isize {
// trace!("{}{}", module_path!(), "::sys_get_time");
    let _us = get_time_us();
...
//引入虚地址后重写 sys_task_info
pub fn sys_task_info(ti: *mut TaskInfo) -> isize {
// trace!("{}{}", module_path!(), "::sys_task_info");
...
//实现sys_set_priority，为任务添加优先级
pub fn sys_set_priority(_prio: isize) -> isize {
// trace!("{}{}", module_path!(), "::sys_set_priority");
    if _prio < 2 {
        -1
    }
    else {
...
//扩展内核以实现 sys_mmap 和 sys_munmap
pub fn sys_mmap(_start: usize, _len: usize, _port: usize) -> isize {
trace!("{}{}", module_path!(), "::sys_mmap");
    mmap(_start, _len, _port)
}

pub fn sys_munmap(_start: usize, _len: usize) -> isize {
trace!("{}{}", module_path!(), "::sys_munmap");
    munmap(_start, _len)
}
